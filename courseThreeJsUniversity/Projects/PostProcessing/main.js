...
function init()
{
	...
	var dotsbutton = document.getElementById("dots").onclick = function() {

		if(effect_dots.enabled)
		{
				effect_dots.enabled = false;
		}
		else
		{
				effect_dots.enabled = true;
		}

	};

	var rgbbutton = document.getElementById("rgb").onclick = function() {

		if(effect_rgb.enabled)
		{
				effect_rgb.enabled = false;
		}
		else
		{
				effect_rgb.enabled = true;
		}
	...
	effect_rgb.uniforms[ 'amount' ].value = 0.0025;
