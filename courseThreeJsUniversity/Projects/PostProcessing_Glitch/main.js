var warningbutton = document.getElementById("disablewarning").onclick = function() {
...
function init()
{
	...
	var glitchbutton = document.getElementById("glitch").onclick = function() {
	...
	var glitchbutton = document.getElementById("glitchwild").onclick = function() {
