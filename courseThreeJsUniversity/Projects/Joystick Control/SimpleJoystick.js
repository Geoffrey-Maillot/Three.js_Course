...
function LoadJoystick()
{
	...
	Html_JoystickMain.addEventListener('mouseleave', Joystick_OnMouseUp, false);
	Html_JoystickMain.addEventListener('mouseout', Joystick_OnMouseUp, false);
