...
import { RenderPixelatedPass } from '../js/examples/jsm/postprocessing/RenderPixelatedPass.js';
...
function init()
{
	...
	var nopixelsbutton = document.getElementById("nopixels").onclick = function() {

				renderPixelatedPass.enabled = false;
	};

	var pixelsbutton10 = document.getElementById("pixels10").onclick = function() {

				renderPixelatedPass.enabled = true;
				renderPixelatedPass.setPixelSize(10);
	};

	var pixelsbutton20 = document.getElementById("pixels20").onclick = function() {

				renderPixelatedPass.enabled = true;
				renderPixelatedPass.setPixelSize(20);
	};
